...
export default function Home() {
  useEffect(() => {
    // Simplified animation logic - left to right sequence
    const cards = document.querySelectorAll('.service-card');
    
    // Simple animation of cards from left to right
    cards.forEach((card, index) => {
      ...
      }, 500 + (index * 500)); // 500ms base delay + 500ms between each card
    });
  }, []);
  return (
    <>
      ...
      {/* Summary Section */}
      <section className="py-20 service-section-bg relative overflow-hidden -mt-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 service-cards-container">
            ...
            <div className="card-medical-bg rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center h-full service-card card-hover-effect">
              <div className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center mb-6">
              ...
              <p className="text-white/90 mb-6 font-medium flex-grow">
              ...
              <Link href="/services" className="text-white font-bold hover:text-blue-200 bg-indigo-700 hover:bg-indigo-800 px-4 py-2 rounded-lg inline-flex items-center transition-all duration-200 mt-auto">
                Learn more
            ...
            <div className="card-dme-bg rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center h-full service-card card-hover-effect">
              <div className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center mb-6">
              ...
              <Link href="/services" className="text-white font-bold hover:text-pink-200 bg-pink-700 hover:bg-pink-800 px-4 py-2 rounded-lg inline-flex items-center transition-all duration-200 mt-auto">
                Learn more
                <svg className="w-4 h-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
            ...
            <div className="card-ai-bg rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center h-full service-card card-hover-effect">
              <div className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center mb-6">
              ...
              <Link href="/services" className="text-white font-bold hover:text-violet-200 bg-violet-700 hover:bg-violet-800 px-4 py-2 rounded-lg inline-flex items-center transition-all duration-200 mt-auto">
                Learn more
                <svg className="w-4 h-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
